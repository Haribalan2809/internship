...
public class transfer extends javax.swing.JFrame {
    ...
    public transfer(String n)
    {
        ...
        try{
            Connection con1=DriverManager.getConnection("jdbc:derby://localhost:1527/intern","haribalan","harish2809");
            Statement stmt1=(Statement)con1.createStatement();
            String query1="select emailid,credit,panno,phonenumber from haribalan.ctable where name = '"+n+"' ";
            ResultSet rs1=stmt1.executeQuery(query1);
            
            while(rs1.next())
            {
                em = rs1.getString("emailid");
                cc = rs1.getInt("credit");
                c = rs1.getString("panno");
                p = rs1.getString("phonenumber");
                String cc1 = Integer.toString(cc);
                jLabel3.setText("EMAIL:"+em);
                jLabel4.setText("PHONE NO:"+ p);
                jLabel5.setText("PANNO:"+c);
    ...
    private void initComponents() {
        ...
        jLabel9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/credit/transfer.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            Connection con1=DriverManager.getConnection("jdbc:derby://localhost:1527/intern","haribalan","harish2809");
            Statement stmt1=(Statement)con1.createStatement();
            String query1="select name from haribalan.ctable ";
            ResultSet rs1=stmt1.executeQuery(query1);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            Connection con1=DriverManager.getConnection("jdbc:derby://localhost:1527/intern","haribalan","harish2809");
            Statement stmt1=(Statement)con1.createStatement();
            String query1="update haribalan.ctable set credit = credit + '"+c+"' where name ='"+n+"'";
        ...
        try{
            ...
            Connection con1=DriverManager.getConnection("jdbc:derby://localhost:1527/intern","haribalan","harish2809");
            Statement stmt1=(Statement)con1.createStatement();
            String query1="update haribalan.ctable set credit = credit - '"+c+"' where name ='"+uname+"'";
            stmt1.executeUpdate(query1);
            stmt1.close();
            con1.close();
        }
